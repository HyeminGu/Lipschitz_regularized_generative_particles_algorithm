...
<img align="center" width="250" alt="KL-Lip1 GPA transporting Gaussian to Sierpinski carpet in 3D" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lipschitz_1_4096_4096_00_test_sierpinski2movie.gif?raw=true"/><img align="center" width="250" alt="alpha2-Lip1 GPA transporting MNIST digit 2 to MNIST digit 0 in 784D" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/alpha=2-lipshitz_1_02_00_0200_0200_00_0movie.gif?raw=true"/><img align="center" width="250" alt="KL-Lip1 GPA transporting 5000 samples from Gaussian to Swiss roll approximated by 200 samples in 3D" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lipschitz_1_0200_5000_00_3d_swiss_roll-movie.gif?raw=true"/>
...
<img align="center" width="860" alt="Gradient flow on probability measures which dissipates the divergence or loss" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/gradient_flow_figure.png?raw=true"/> 
...
<img align="center" width="1040" alt="Comparison of computational schemes: Left - GAN, Right - GPA" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/gpa_vs_gan.png?raw=true"/> 
...
| :-------------------------------: | :-------------------------------: | :-------------: |
|  <img align="center" height="220" alt="Generated images from KL-Lip1 GPA using 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lip1-gpa-600_200samples.png?raw=true"/> |  <img align="center" height="220" alt="Generated images from KL-Lip1 GAN using 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lip1-gan-200samples.png?raw=true"/> |  <img align="center" height="220" alt="Generated images from Wasserstein GAN using 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/wasserstein-gan-200samples.png?raw=true"/> |
...
| :---------------------------------------------------------: | :----------------------------------: | :-----------------------------------------: |
|  <img align="center" width="600" alt="KL-Lip1 GAN training loss decrease using 200 target samples and 200 target samples + 5000 augmented samples obtained by KL-Lip1 GPA" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/data_augmentation_influence.png?raw=true"/> |  <img align="center" width="550" alt="Generated samples from KL-Lip1 GAN using 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/without_augmentation.png?raw=true"/> |  <img align="center" width="220" alt="Generated samples from KL-Lip1 GAN using 200 target samples + 5000 augmented samples obtained by KL-Lip1 GPA" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/with_augmentation.png?raw=true"/> |
...
|:----------------------:|
| <img align="center" height="220" alt="MNIST 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lipschitz_1_cond_0200_0600_00_check_overfitting-tiled_target.png?raw=true"/> |


|$M=200$ Generated samples from $(f\_\text{KL}, \Gamma_1)$-GPA | $M=600$ Generated samples from $(f\_\text{KL}, \Gamma_1)$-GPA |
|:--------------------------------------------------------:|:---------------------------------------------------------------------:|
|<img align="center" height="220" alt="MNIST 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lip1-gpa-200_200samples.png?raw=true"/> | <img align="center" height="220" alt="MNIST 200 target samples" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/kl-lip1-gpa-600_200samples.png?raw=true"/> |
...
|:--------------------------------------------------------:|:---------------------------------------------------------------------:|
|<img align="center" height="220" alt="Two data sets showing batch effects" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/source_target-dim50-standardize_all_3.png?raw=true"/> | <img align="center" height="220" alt="Integrated data sets from GPA" src="https://github.com/HyeminGu/Lipschitz_regularized_generative_particles_algorithm/tree/main/figures/transported_target-dim50-standardize_all_3.png?raw=true"/> |
